      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="bg-white rounded-xl shadow-lg p-6 lg:col-span-2">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
              <div>
                <label class="text-sm font-medium text-gray-500 uppercase tracking-wide">ชื่อจริง</label>
                <p class="text-lg text-gray-900 mt-1">{{ userData.firstName }}</p>
              </div>
              
              <div>
                <label class="text-sm font-medium text-gray-500 uppercase tracking-wide">นามสกุล</label>
                <p class="text-lg text-gray-900 mt-1">{{ userData.lastName }}</p>
              </div>
              
              <div>
                <label class="text-sm font-medium text-gray-500 uppercase tracking-wide">ชื่อผู้ใช้</label>
            ...
            <div class="space-y-4">
              <div>
                <label class="text-sm font-medium text-gray-500 uppercase tracking-wide">อีเมล</label>
                <p class="text-lg text-gray-900 mt-1">{{ userData.email }}</p>
              </div>
              
              <div>
                <label class="text-sm font-medium text-gray-500 uppercase tracking-wide">เพศ</label>
                <p class="text-lg text-gray-900 mt-1">{{ userData.gender }}</p>
              </div>
              
              <div>
                <label class="text-sm font-medium text-gray-500 uppercase tracking-wide">รหัสผู้ใช้</label>
            ...
            <div class="space-y-4">
              <div class="bg-blue-50 rounded-lg p-4">
                <div class="flex items-center justify-between">
                  <span class="text-blue-700 font-medium">ส่วนสูง</span>
              ...
              <div class="bg-green-50 rounded-lg p-4">
                <div class="flex items-center justify-between">
                  <span class="text-green-700 font-medium">น้ำหนัก</span>
...
console.log('userData in profile:', userData.value);
...
const bmiCategory = computed(() => {
  ...
  if (bmiValue < 18.5) return 'น้ำหนักน้อยกว่าเกณฑ์'
  if (bmiValue < 25) return 'น้ำหนักปกติ'
  if (bmiValue < 30) return 'น้ำหนักเกิน (ท้วม)'
  return 'โรคอ้วน'
})
...
definePageMeta({
  ...
  middleware:'auth',
  meta: [
    { name: 'description', content: 'หน้าโปรไฟล์ผู้ใช้สำหรับแอปพลิเคชัน JR SMARTBREATH' },
    { name: 'keywords', content: 'โปรไฟล์, ผู้ใช้, JR SMARTBREATH, สุขภาพ, ฟิตเนส' }
  ]
})
</script>