      ...
      <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <NuxtLink to="/menu"
              class="flex items-center space-x-3 text-xl font-bold text-gray-900 hover:text-blue-600 transition-colors">
              <div
                class="w-8 h-8 bg-gradient-to-br  rounded-lg flex items-center justify-center">
                <img src="/icons/icon.png" alt="icon" class="w-5 h-5" />
              </div>
              <span>SMARTBREATH</span>
            </NuxtLink>
          </div>
            ...
            <div class="relative" ref="userMenuContainer">
              ...
              <Transition enter-active-class="transition ease-out duration-100"
                ...
                <div v-show="showUserMenu"
                  ...
                  <NuxtLink to="/profile" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">โปรไฟล์ของฉัน
                  </NuxtLink>
        ...
        <div v-if="showMobileMenu" class="md:hidden border-t border-gray-200 py-2">
          <div v-if="userStore.isLoggedIn" class="border-t border-gray-200 pt-4 pb-3">
            ...
            <div class="mt-3 space-y-1">
              ...
              <button @click="handleLogout"
                class="w-full text-left block px-3 py-2 text-base font-medium text-red-600 hover:text-red-600 hover:bg-red-50 rounded-md">
                ออกจากระบบ
              </button>
            </div>
          </div>
    ...
    <footer class="bg-white border-t border-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <p class="text-center text-gray-500 text-sm">
          © 2025 SMARTBREATH. All rights reserved.
        </p>
      </div>
    </footer>
  </div>
